export default function Container() {
    return (
        <>
            <div className=" h-screen font- font-minionPro flex justify-center items-center bg-white sm:bg-white md:bg-white lg:bg-[#f1f1f1] md:px-0">
                        ...
                        <div className="mt-2">
                            <form className="flex flex-col  " method="POST" action="#">
                                <div className="mb-2 pt-1 rounded ">
                                    <label className="block text-gray-500 text-xl mb-1 " for="email">Email</label>
                                ...
                                <div className="mb-2 pt-1 rounded ">
                                    <label className="block text-gray-500 text-xl  mb-1 " for="password">Password</label>
                                ...
                                <div className="flex justify-start">
                                    <a href="#" className="text-md text-[#1A3765]  hover:text-gray-600  mb-2">Forgot your password?</a>
                                </div>
                                <button className=" text-xl h-12 mt-2 text-white w-full bg-[#1A3765] hover:bg-blue-900">Log in</button>
