        ...
        >
          <ul className="pt-4 flex flex-col lg:flex-row list-none lg:ml-auto">
            <li className="nav-item h-full">
              <a
                className="px-3 py-1  font-serif flex items-center  text-2xl text-blue-900 opacity-40 font-bold leading-snug  hover:opacity-75"
                href="#"
              >
                Home
              </a>
            ...
            <li className="pl-2  nav-item h-full">
              <button className="rounded-full px-10 py-1 font-serif tracking-wide text-2xl text-white capitalize transition-colors duration-200 transform bg-blue-900  hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                Register
              </button>
            </li>
          </ul>
