export default function Container() {
    return (
        <>
            <div className="h-screen flex justify-center items-center bg-white sm:bg-white md:bg-white lg:bg-[#f1f1f1] md:px-0">
                        ...
                        <div className="mt-2">
                            <form className="flex flex-col  " method="POST" action="#">
                                ...
                                <div className="flex justify-start">
                                    <a href="#" className="text-sm ttext-gray-400 hover:text-gray-600  mb-2">Forgot your password?</a>
                                </div>
