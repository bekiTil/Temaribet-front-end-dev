...
const ProfileCard = () => {
  return (
    <div className='flex flex-col rounded-2xl bg-[#fcfcfc] mb-5 p-5 text-[#1a3465]' style={{border: "1px solid lightgray"}}>
        <p className='font-serif font-bold text-lg md:text-xl lg:text-2xl uppercase mb-3'>Bole Michael</p>
        <div className='flex'>
        ...
        <p className='text-base mt-4'>asjhfla sdkfhlaksfjh sdjfhlaksjhsd jfhd 
           lajsdhf sh fs sjdfh sdjfh ljsf kjsdjf jfj
           lasjdf ljskdjf lsjls
           asjhfla sdkfhlaksfjh sdjfhlaksjhsd jfhd
           asjhfla sdkfhlaksfjh sdjfhlaksjhsd jfhd
           asjhfla sdkfhlaksfjh sdjfhlaksjhsd jfhd
        </p>
